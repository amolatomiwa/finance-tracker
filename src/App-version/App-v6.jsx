// added a feature that sort the transaction history by date from the oldest to the newest
// add a filter to ignore the income-category "Carry Over" when displaying the top income categories for the month
              ...
              <div className="space-y-6">
                {categoryBreakdown.incomeCategories.length > 0 && (
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                      {categoryBreakdown.incomeCategories
